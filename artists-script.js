const artistData = {
    ...
    'frostability': { name: 'Frostability', desc: "Hi, I'm Frostability/Ayden or you can call me Fr0stability if you know me for my emo music, i make similar music to feelslikehome or s0rroww", img: 'images /frostability.jpg', spotify: 'https://open.spotify.com/artist/6Pnqtln6eh4XN3dOTz82h0?si=EBklKxGkS4uuQBLygW6Qew', soundcloud: '', insta: 'https://instagram.com/aydensstuff_' },
    'undyingbear': { name: 'undyingbear', desc: "undyingbear/Jude is an instrumentalist and is a beginner at composing music. He is one of the top 5 artists to join Paper Vinyl Records", img: 'images /undyingbear.jpg', spotify: 'https://open.spotify.com/artist/3sLlAACq5X1c0tey9Um4iR?si=I2KMKaGqSFGakGAnjb5w5A', soundcloud: '', insta: 'https://instagram.com/undying64' },
    ...
    'smitebite': { name: 'SmiteBite', desc: "Not much is known about SmiteBite at the moment.", img: 'images /smitebite.jpg', spotify: '', soundcloud: 'https://soundcloud.com/smite-bite-14261925', insta: '' }
};
