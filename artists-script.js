...
function openArtist(id) {
    ...
    // Direct local hyperlink routing
    if (data.presave) {
        linksContainer.innerHTML += `<a href="${data.presave}" class="presave-icon" title="Pre-Save Upcoming Music"><svg viewBox="0 0 24 24"><path d="M12 2v14c-.56-.37-1.24-.6-2-.6-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V6h6V2h-8z"/></svg></a>`;
    }
