const artistData = {
    'wilrhy': { name: 'WilRhy', desc: "", img: 'images /wilrhy.jpg', spotify: 'https://spotify.com', soundcloud: '', insta: 'https://instagram.com', twitter: '' },
    'frostability': { name: 'Frostability', desc: "", img: 'images /frostability.jpg', spotify: 'https://spotify.com', soundcloud: '', insta: 'https://instagram.com', twitter: '' },
    'undyingbear': { name: 'undyingbear', desc: "", img: 'images /undyingbear.jpg', spotify: 'https://spotify.com', soundcloud: '', insta: 'https://instagram.com', twitter: '' },
    'twistedanimations': { name: 'TwistedAnimations', desc: "", img: 'images /twistedanimations.jpg', spotify: 'https://spotify.com', soundcloud: '', insta: '', twitter: '' },
    'smitebite': { name: 'SmiteBite', desc: "", img: 'images /smitebite.jpg', spotify: '', soundcloud: 'https://soundcloud.com', insta: '', twitter: '' },
    // New Artist Profile Data
    'badmicgames': { name: 'BadMicGames', desc: "", img: 'images /badmicgames.jpg', spotify: '', soundcloud: '', insta: '', twitter: '' }
};
...
function openArtist(id) {
    ...
    if (data.twitter) linksContainer.innerHTML += `<a href="${data.twitter}" target="_blank" class="twitter-icon"><svg viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>`;
...
window.onclick = function(event) {
    const modal = document.getElementById('artist-modal');
    if (event.target == modal) closeArtist();
}
